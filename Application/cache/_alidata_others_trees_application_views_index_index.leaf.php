...
<?php echo $this->tag->stylesheetLink('ui/style/font-awesome.css'); ?><!-- Font awesome icon -->
<?php echo $this->tag->stylesheetLink('ui/style/jquery-ui.css'); ?><!-- jQuery UI -->
<?php echo $this->tag->stylesheetLink('ui/style/fullcalendar.css'); ?><!-- Calendar -->
<?php echo $this->tag->stylesheetLink('ui/style/prettyPhoto.css'); ?><!-- prettyPhoto -->
<?php echo $this->tag->stylesheetLink('ui/style/rateit.css'); ?><!-- Star rating -->
<?php echo $this->tag->stylesheetLink('ui/style/bootstrap-datetimepicker.min.css'); ?><!-- Date picker -->
<?php echo $this->tag->stylesheetLink('ui/style/jquery.cleditor.css'); ?><!-- CLEditor -->
<?php echo $this->tag->stylesheetLink('ui/style/uniform.default.css'); ?><!-- Uniform -->
<?php echo $this->tag->stylesheetLink('ui/style/bootstrap-switch.css'); ?><!-- Bootstrap toggle -->
<?php echo $this->tag->stylesheetLink('ui/style/style.css'); ?><!-- Main stylesheet -->
<?php echo $this->tag->stylesheetLink('ui/style/widgets.css'); ?><!-- Widgets stylesheet -->

<!-- HTML5 Support for IE -->
<!--[if lt IE 9]>
<script src="ui/js/html5shim.js"></script>
<![endif]-->
              ...
              <div class="widget">
                ...
                <div class="widget-content referrer">
                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                      <td><img src="ui/img/icons/chrome.png" alt="" />
                      <td>Google Chrome</td>
                      <td>3,005</td>
                    </tr> 
                    <tr>
                      <td><img src="ui/img/icons/firefox.png" alt="" />
                      <td>Mozilla Firefox</td>
                      <td>2,505</td>
                    </tr> 
                    <tr>
                      <td><img src="ui/img/icons/ie.png" alt="" />
                      <td>Internet Explorer</td>
                      <td>1,405</td>
                    </tr> 
                    <tr>
                      <td><img src="ui/img/icons/opera.png" alt="" />
                      <td>Opera</td>
                      <td>4,005</td>
                    </tr> 
                    <tr>
                      <td><img src="ui/img/icons/safari.png" alt="" />
                      <td>Safari</td>
                      <td>505</td>
                    </tr>                                                                    
                  </table>
...
<!-- JS -->
<script src="ui/js/jquery.js"></script> <!-- jQuery -->
<script src="ui/js/bootstrap.js"></script> <!-- Bootstrap -->
<script src="ui/js/jquery-ui-1.9.2.custom.min.js"></script> <!-- jQuery UI -->
<script src="ui/js/fullcalendar.min.js"></script> <!-- Full Google Calendar - Calendar -->
<script src="ui/js/jquery.rateit.min.js"></script> <!-- RateIt - Star rating -->
<script src="ui/js/jquery.prettyPhoto.js"></script> <!-- prettyPhoto -->

<!-- jQuery Flot -->
<script src="ui/js/excanvas.min.js"></script>
<script src="ui/js/jquery.flot.js"></script>
<script src="ui/js/jquery.flot.resize.js"></script>
<script src="ui/js/jquery.flot.pie.js"></script>
<script src="ui/js/jquery.flot.stack.js"></script>

<!-- jQuery Notification - Noty -->
<script src="ui/js/jquery.noty.js"></script> <!-- jQuery Notify -->
<script src="ui/js/themes/default.js"></script> <!-- jQuery Notify -->
<script src="ui/js/layouts/bottom.js"></script> <!-- jQuery Notify -->
<script src="ui/js/layouts/topRight.js"></script> <!-- jQuery Notify -->
<script src="ui/js/layouts/top.js"></script> <!-- jQuery Notify -->
<!-- jQuery Notification ends -->

<script src="ui/js/sparklines.js"></script> <!-- Sparklines -->
<script src="ui/js/jquery.cleditor.min.js"></script> <!-- CLEditor -->
<script src="ui/js/bootstrap-datetimepicker.min.js"></script> <!-- Date picker -->
<script src="ui/js/jquery.uniform.min.js"></script> <!-- jQuery Uniform -->
<script src="ui/js/bootstrap-switch.min.js"></script> <!-- Bootstrap Toggle -->
<script src="ui/js/filter.js"></script> <!-- Filter for support page -->
<script src="ui/js/custom.js"></script> <!-- Custom codes -->
<script src="ui/js/charts.js"></script> <!-- Charts & Graphs -->
